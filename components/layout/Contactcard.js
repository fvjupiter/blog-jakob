    ...
    return (
      <>
        <div
          ...
          className={`${
            isContact ? "visible" : "hidden"
          } fixed inset-0 backdrop bg-black/60 center z-[1000] cursor-alias`}
        >
          <div
            style={{ maxHeight: screen.height - 200, border: "2px solid blue" }}
          ...
          >
            ...
            <div className={`text-center`}>
              <BsX
                className="fixed left-0 top-0 mt-2 ml-2 cursor-pointer text-gray-300 hover:text-white"
                onClick={() => setisContact(false)}
                size={30}
              />
              ...
              <div className="w-full between mx-auto max-w-[220px]">
                ...
                <a
                  href="mailto:jakobwayne22@gmail.com"
                  className="cursor-pointer hover:text-indigo-400 text-indigo-200"
                >
              ...
              <br />
              <div>
                {documentToReactComponents(info.about, richText_Options)}
              </div>
            </div>
          </div>
        </div>
